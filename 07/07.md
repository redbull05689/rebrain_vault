...
echo "hvs.NAHv4mfANKDXPMqRRNmXEQjK" > /home/user/root_token

export VAULT_TOKEN="hvs.NAHv4mfANKDXPMqRRNmXEQjK"
...
vault policy write cert-issue-policy - << EOF
...
echo hvs.CAESIOimlXqibtogr_WUsxRPTNY-mCcrnUJxeI42HHvhfScaGh4KHGh2cy54Z2twR1B3bEt4SjNXYzRVSmtlTzRPY > /home/user/cert_issuer_token
---
...
cat <<EOT >> payload-7.json
{
"common_name": "rebrain-vault.local",
"alt_names": "random.rebrain-vault.local"
}
EOT
